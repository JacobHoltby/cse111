...
def print_death_age(people_dict):
    ...
    for person in people_dict.items():
        key = person[0]
        value = person[1]
        age_of_death = value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]
        birth_year = value[BIRTH_YEAR_INDEX]
        death_year = value[DEATH_YEAR_INDEX]
        print(f"{value[NAME_INDEX]}, {age_of_death}, {birth_year}, {death_year}")
    pass
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    for marriage_key, marriage_value in marriages_dict.items():
        husband_key = marriage_value[HUSBAND_KEY_INDEX]
        wife_key = marriage_value[WIFE_KEY_INDEX]
        
        year = marriage_value[WEDDING_YEAR_INDEX]
        
        husband_name = NULL
        husband_birth = NULL
        husband_marriage_age = NULL
        
        wife_name = NULL
        wife_birth = NULL
        wife_marriage_age = NULL
        ...
        if husband_key in people_dict:
            ...
            husband_marriage_age = year - husband_birth
        ...
        if wife_key in people_dict:
            ...
            wife_marriage_age = year - wife_birth
        
        print(f'{husband_name} {husband_marriage_age} > {year} < {wife_name} {wife_marriage_age}')
    pass
